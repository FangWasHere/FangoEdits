    ...
    for place in locations:
        ...
        if game.clan.override_biome:
            if req_biome == game.clan.override_biome:
                if "any" in req_camps or clan.camp_bg in req_camps:
...
def event_for_tags(tags: list, cat, clan=CatGroup.PLAYER_CLAN_ID, other_cat=None) -> bool:
    """
...
def event_for_poi(pois: dict[str, list], clan=None) -> bool:
    """
